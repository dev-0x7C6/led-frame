...
RedChannelCorrector::RedChannelCorrector(const int owner)
...
GreenChannelCorrector::GreenChannelCorrector(const int owner)
		: Abstract::AbstractCorrector(owner) {}
...
BlueChannelCorrector::BlueChannelCorrector(const int owner)
		: Abstract::AbstractCorrector(owner) {}

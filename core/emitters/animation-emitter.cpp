...

{
	...
	m_animation.setKeyValueAt(0.000, QColor::fromRgbF(0, 0, 0));
	m_animation.setKeyValueAt(0.500, QColor::fromRgbF(0, 0, 1));
	m_animation.setKeyValueAt(1.000, QColor::fromRgbF(0, 0, 0));

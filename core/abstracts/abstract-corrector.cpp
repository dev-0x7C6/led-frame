...
void AbstractCorrector::setEnabled(const bool &enabled) { m_enabled = enabled; }
void AbstractCorrector::setFactor(const float &factor) { m_factor = factor; }
void AbstractCorrector::setPriority(const uint32_t &priority) { m_priority = priority; }
